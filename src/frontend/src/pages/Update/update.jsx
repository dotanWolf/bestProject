      ...
      return (
        <div className="preview-container">
           {content && content.length > 50 ? (
             ...
             <div className="no-preview" style={{color: 'white', textAlign: 'center', marginTop: '50px'}}>
                <h3 style={{color: '#ff6b6b'}}>Image Corrupted</h3>
                <p>This file is empty or broken.</p>
                <p style={{fontSize: '0.9rem', color: '#ccc'}}>Try deleting and re-uploading it.</p>
             </div>
           )}
           {/* Hidden fallback div for onError */}
           <div className="no-preview" style={{display: 'none', color: 'white', textAlign: 'center', marginTop: '50px'}}>
